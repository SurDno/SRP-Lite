...
- Fixed the "Barrel modification" upgrade for the Chaser 13 failing to add the 'doesn't use shot' text to the weapon information tooltip despite disabling use of buckshot. - Decane
